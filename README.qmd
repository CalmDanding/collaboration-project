...
This project is based on `targets` to do the analysis. If you want to redo the analysis or use codes, please use the `targets` package.
...
Then you can get the report named `Final Reprot` in the project folder.
...
tar_visnetwork()
```
According to this plot, you can know the names of the data sets and models I got. Futhermore, you can also know what functions generate wihch data set.
...
This report is about the analysis and get a predictive model of gene expression. The final linear model (parameters) I got is 
