...
First click `collaboration-project.Rproj` to open the project file.

This project is based on `targets` to do the analysis. If you want to redo the project or use codes, please install and load the `targets` package.
...
Then you can get the project report named `IMRaD Reprot` in the project folder.
...
This report is based on this project.
